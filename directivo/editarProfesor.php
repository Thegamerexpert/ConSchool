...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE usuario SET Nombre='$nombre', Apellidos='$apellidos', contraseña='$password', id_centro='$id_centro', cursoActual='$cursoActual' WHERE idUsuario='$id'";
...
<body>
	...
	<div class="contenedor">
		...
		<div class="colContenido bajando">
            ...
            ID Profesor: <input type="number" name="id"><br>
