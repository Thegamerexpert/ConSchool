...
$asignaturas = mysqli_query($conn, "SELECT idAsignatura, Nombre FROM asignatura WHERE Curso = 'Segundo'");
...
<body>
    ...
    <div class="contenedor">
        ...
        <table>
            ...
            <tbody>
                ...
                $queryTodasNotas = "SELECT u.Nombre AS NombreAlumno, u.Apellidos AS ApellidosAlumno, a.Nombre AS NombreAsignatura, n.calificacion FROM nota n
                                    ...
                                    WHERE u.cursoActual = 'Segundo' AND u.tipo = 'alumno'";
        ...
        <form action="mostrarNotas2.php" method="post">
