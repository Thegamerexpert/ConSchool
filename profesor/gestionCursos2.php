...
$alumnos = obtenerAlumnosPorCurso("Segundo");
$asignaturas = obtenerAsignaturasPorCurso("Segundo");
...
<p>Número de centro: <span id="centro">Centro</span></p>
        ...
        <section class="panel">
        <h1 class="textoal">Alumnos Segundo</h1>
    <ul >
    ...
    <section class="panel">
    <h1 class="textoal">Asignaturas Segundo</h1>
    <ul >
    ...
    <section class="panel">
    <h1 class="textoal">Materiales Segundo</h1>
